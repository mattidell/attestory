"""Generate the additive Schedule B interest-adjustment v11 route.

This generator reads the accepted v10/v5 route and writes only new content
citizens plus the v11 package, v6 publication registry, v6 release, and v11
synthetic adoption.  It introduces no schema or evaluator operation.
"""
...
def _schedule_b_v4() -> dict[str, Any]:
    ...
    part_i["authority"]["composition"]["version"] = "v3"
...
def render_content_files() -> dict[str, dict[str, Any]]:
    ...
    package = _load(CONTENT / "package.core-calculations.v13.json")
    package["schema"] = "artifact-package.v12"
    package["version"] = "v15"
    ...
    members.append({
        "id": "tax.us.2025.interest-composition",
        "role": "composition",
    ...
    registry = _load(CONTENT / "published-packages.v9.json")
