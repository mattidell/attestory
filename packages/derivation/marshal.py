...
def _rule_required_symbols(rule: dict[str, Any]) -> list[str]:
    ...
    """
    if rule.get("schema") in {"attachment-rule.v1", "attachment-rule.v2", "attachment-rule.v3", "attachment-rule.v4", "attachment-rule.v5", "attachment-rule.v6", "attachment-rule.v8", "attachment-rule.v9"}:
