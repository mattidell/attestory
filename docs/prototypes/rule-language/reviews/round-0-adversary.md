...
Artifact under review: `docs/prototypes/rule-language/charter-it1.md`.
Context read: `docs/prototypes/rule-language/harvest-notes.md`, `docs/prototypes/rule-language/reviews/round-0.md`, `docs/prototypes/rule-language/reviews/round-0-governance.md`, role files for governance, expressiveness, and adversary review, `docs/governance/`, and official IRS 2025 Form 1040, Schedule B, Form 1040 instructions, and Form 1099-INT material.
