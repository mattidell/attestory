...
Environment note: each Python invocation emitted `pyenv: cannot rehash: /Users/mattidell/.pyenv/shims isn't writable` before output. The command still returned 0 and produced valid JSON after that warning.
