...
- **Working location:** `docs/prototypes/non-publication-explanations/it2/` on the milestone working tree; foreman holds git custody (no branch, tag, merge, or commit by the builder).
...
- `docs/prototypes/non-publication-explanations/it2/design.md`
- `docs/prototypes/non-publication-explanations/examination-it2.md` (≤120 lines) stating NPE-P1 and NPE-P2 separately as settled-at-static-level or unresolved, citing every case.
