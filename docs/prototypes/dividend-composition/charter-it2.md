...
- **Builder:** clean-room rival, High tier, independent context. **Sealed:**
  ...
  stop and report.
- **Working location:** `docs/prototypes/dividend-composition/it2/`; foreman
  holds git custody.
...
- `docs/prototypes/dividend-composition/it2/design.md` (≤250 lines)
- `docs/prototypes/dividend-composition/examination-it2.md` (≤100 lines)
