...
- **Working location:** `docs/prototypes/expression-language-extensions/it1/`; foreman holds git custody.
...
Read: the topic `plan.md`, this charter, `docs/governance/`, ADRs 0002, 0004, 0006–0012, 0016, 0017, 0023, 0024, and committed `packages/derivation/` and `packages/kernel/` source and schemas. The conditional-selectors evidence (`docs/prototypes/conditional-selectors/evaluation-analysis.md`, round-1R/2R reviews, `it2/design.md`) is *in scope* for the incumbent — you are designing to close its recorded gap.
...
- `docs/prototypes/expression-language-extensions/it1/design.md`
- `docs/prototypes/expression-language-extensions/examination-it1.md` (≤120 lines) stating ELX-P1 and ELX-P2 separately as settled-at-static-level or unresolved, citing every case.
