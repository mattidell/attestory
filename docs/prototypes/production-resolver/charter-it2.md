...
- **Builder:** clean-room rival, High tier, independent context, **sealed from
  the incumbent**.
- **Working location:** `docs/prototypes/production-resolver/it2/`; foreman holds git custody.
...
- `docs/prototypes/production-resolver/it2/design.md` (≤ 300 lines)
- `docs/prototypes/production-resolver/examination-it2.md` (≤ 120 lines) stating
