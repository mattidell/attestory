...
- **Working location:** `docs/prototypes/citation-resolution/it1/`; foreman holds git custody.
...
**Read:** this charter, `docs/prototypes/citation-resolution/plan.md`, `docs/governance/`, accepted ADRs **0003**, **0006**, **0012**, **0027**, **0028**, and committed `packages/schemas/` (esp. form-field, rule-artifact), `packages/derivation/`, and 2025 content as *reference shapes* for where opaque citation strings sit today — not as the answer.
...
- `docs/prototypes/citation-resolution/it1/design.md`
- `docs/prototypes/citation-resolution/examination-it1.md` (≤120 lines) stating CIT-P1 and CIT-P2 separately as settled-at-static-level or unresolved, citing every required case.
