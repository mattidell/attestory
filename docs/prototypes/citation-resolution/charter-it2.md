...
- **Working location:** `docs/prototypes/citation-resolution/it2/`; foreman holds git custody.
...
- `docs/prototypes/citation-resolution/it1/` (any file)
- `docs/prototypes/citation-resolution/examination-it1.md`
...
**You may read:** this charter, `docs/prototypes/citation-resolution/plan.md`, `docs/governance/`, *accepted* ADRs **0003**, **0006**, **0012**, **0027**, **0028**, and committed `packages/schemas/`, `packages/derivation/`, and 2025 content as reference shapes for where opaque citation strings sit today.
...
- `docs/prototypes/citation-resolution/it2/design.md`
- `docs/prototypes/citation-resolution/examination-it2.md` (≤120 lines)
