...
`docs/prototypes/tax-citizen-families/it3/` on that branch. The builder may copy
...
The builder writes `docs/prototypes/tax-citizen-families/examination-it3.md` on
