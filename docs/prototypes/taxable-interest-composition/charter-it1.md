...
- **Working location:** `docs/prototypes/taxable-interest-composition/it1/`; foreman holds git custody.
...
- `docs/prototypes/taxable-interest-composition/it1/design.md`
- `docs/prototypes/taxable-interest-composition/examination-it1.md` (≤120 lines) stating TIC-P1 and TIC-P2 separately as settled-at-static-level or unresolved, citing every case.
