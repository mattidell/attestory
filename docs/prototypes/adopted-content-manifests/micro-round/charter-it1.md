...
- **Working location:** `docs/prototypes/adopted-content-manifests/micro-round/it1/`; foreman holds git custody.
...
- Parent `docs/prototypes/adopted-content-manifests/plan.md`, `evaluation-analysis.md`, main-round `it1/` and `it2/` designs, and reviews (ACM-G1, ACM-A3, ACM-A4, ACM-A7 especially)
...
**Read:** this charter, `docs/prototypes/adopted-content-manifests/micro-round/plan.md`, `docs/governance/`, the ADRs listed above, and committed `packages/schemas/` (esp. fact-type, bundle, act-bundle-adoption, source-closure-mapping), `packages/derivation/` (`package_validation.py`, `loader.py`), and 2025 content as *reference shapes*.
...
- `docs/prototypes/adopted-content-manifests/micro-round/it1/design.md`
- `docs/prototypes/adopted-content-manifests/micro-round/examination-it1.md` (≤100 lines) stating MR-P1 and MR-P2 separately as settled-at-static-level or unresolved, citing every required case.
