...
- **Working location:** `docs/prototypes/qdcg-worksheet/it2/`; foreman holds
  git custody.
...
- `docs/prototypes/qdcg-worksheet/it2/design.md` (≤300 lines)
- `docs/prototypes/qdcg-worksheet/examination-it2.md` (≤100 lines) stating
