...
- **Builder:** clean-room rival, High tier, independent context, **sealed from
  the incumbent**.
- **Working location:** `docs/prototypes/contribution-boundary/it2/`; foreman holds git custody.
...
- `docs/prototypes/contribution-boundary/it2/design.md`
- `docs/prototypes/contribution-boundary/examination-it2.md` (≤120 lines) stating
