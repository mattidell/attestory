...
- **Working location:** `docs/prototypes/contribution-boundary/it1/`; foreman holds git custody.
...
- `docs/prototypes/contribution-boundary/it1/design.md`
- `docs/prototypes/contribution-boundary/examination-it1.md` (≤120 lines) stating
