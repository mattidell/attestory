...
`docs/archive/2026-08-02-milestone-artifacts/reviews/2026-07-15-core-tax-conditions-premerge-review.md`: findings classified decision-blocking / production-condition / non-blocking, a keep-vs-redo recommendation, and a verdict on merge-readiness. Advisory — the owner decides disposition.
