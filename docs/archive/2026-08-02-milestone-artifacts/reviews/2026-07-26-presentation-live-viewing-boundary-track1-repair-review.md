...
Charter: `docs/archive/2026-08-02-milestone-artifacts/reviews/charter-2026-07-26-presentation-live-viewing-boundary-track1-repair-review.md`
...
| **Exact object** | Finding 1, Observation 1, and the invariants the repair's diff touches: `docs/adr/0047-live-viewing-environment.md`, `docs/adr/analyses/0047-live-viewing-environment.md`, `docs/adr/INDEX.md`, `docs/archive/2026-08-02-milestone-artifacts/phases/real-return/milestones/presentation-live-viewing-boundary.md`. Measurements 1/3/4/5 from the original review are not re-derived except where this diff reaches them. |
