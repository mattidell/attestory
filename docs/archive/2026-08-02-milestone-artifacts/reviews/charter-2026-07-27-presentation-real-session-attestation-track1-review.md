...
- Full reads before acting: this charter; the build charter `docs/archive/2026-08-02-milestone-artifacts/reviews/charter-2026-07-27-presentation-real-session-attestation-track1.md`; the milestone plan; `docs/adr/0047-live-viewing-environment.md`; `docs/adr/0031-real-data-residency-boundary.md`; the unit under review; `packages/derivation/live_session.py`; `packages/derivation/live_viewing.py`; `AGENTS.md` ("Data Safety Rules")
