...
- Full reads before acting: this charter; the milestone plan; `docs/adr/0047-live-viewing-environment.md`; `docs/adr/0031-real-data-residency-boundary.md`; `packages/derivation/live_session.py`; `docs/archive/2026-08-02-milestone-artifacts/reviews/2026-07-27-presentation-live-session-path-track3-rehearsal.md`; `AGENTS.md` ("Data Safety Rules")
