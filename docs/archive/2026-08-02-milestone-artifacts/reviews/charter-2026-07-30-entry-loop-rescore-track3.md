...
- Evaluator files: `docs/archive/2026-08-02-milestone-artifacts/reviews/2026-07-30-entry-loop-rescore-track2-evaluator-e.md` (Builder brief), `…-evaluator-f.md` (Reviewer brief)
...
At `docs/archive/2026-08-02-milestone-artifacts/reviews/2026-07-30-entry-loop-rescore-track2-aggregation.md`:
