...
> You are the legibility reviewer for the rule-language prototype. Read ONLY: `docs/archive/2026-08-02-milestone-artifacts/prototypes/rule-language/roles/reviewer-legibility.md` and the artifact files listed in the round file named there. Do not read anything else in this repository — no governance docs, no charter, no examination, no other reviews, no README.
