# Charter: Iteration 2 — QDCG Worksheet and Declared Absence (Clean-Room Rival)
...
- **Working location:** `docs/archive/2026-08-02-milestone-artifacts/prototypes/qdcg-worksheet/it2/`; foreman holds
  git custody.
...
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/qdcg-worksheet/it2/design.md` (≤300 lines)
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/qdcg-worksheet/examination-it2.md` (≤100 lines) stating
...
boundary and two authorized probe questions, the clean-room seal, and stop conditions.
