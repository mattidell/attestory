...
- **Proposed working location:**
  `docs/archive/2026-08-02-milestone-artifacts/prototypes/qdcg-worksheet/repair2/`.
...
- **Inputs:** this charter; `repair1/design.md` and
  ...
  (`docs/archive/2026-08-02-milestone-artifacts/prototypes/conditional-multi-dependency-nonpublication/`); the
  committed `conditional_dependency_set` node
  (`packages/derivation/evaluator.py`) and its production review chain
  (`docs/archive/2026-08-02-milestone-artifacts/reviews/2026-07-19-dsbs-t0a-cmdn-review.md`,
