...
**Read (authorized).**
`docs/phase-state.md`;
`docs/archive/2026-08-02-milestone-artifacts/prototypes/qdcg-worksheet/plan.md`;
`docs/archive/2026-08-02-milestone-artifacts/prototypes/qdcg-worksheet/it1/design.md` +
`docs/archive/2026-08-02-milestone-artifacts/prototypes/qdcg-worksheet/examination-it1.md` (incumbent);
`docs/archive/2026-08-02-milestone-artifacts/prototypes/qdcg-worksheet/it2/design.md` +
`docs/archive/2026-08-02-milestone-artifacts/prototypes/qdcg-worksheet/examination-it2.md` (clean-room rival);
...
`docs/archive/2026-08-02-milestone-artifacts/prototypes/qdcg-worksheet/reviews/governance-r1.md`, any synthesis,
