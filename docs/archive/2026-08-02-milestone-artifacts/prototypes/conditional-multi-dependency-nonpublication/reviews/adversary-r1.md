...
- **Stop Conditions:** Write only `docs/archive/2026-08-02-milestone-artifacts/prototypes/conditional-multi-dependency-nonpublication/reviews/adversary-r1.md`. Conclude with proposition-by-proposition sufficiency and a narrow sufficient/insufficient verdict. No other file edits or commits are permitted.
