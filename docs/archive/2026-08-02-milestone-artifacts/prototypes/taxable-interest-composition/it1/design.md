...
Date: 2026-07-14. Builder: incumbent. Evidence depth: Rung 2 (paper schema/canon diffs and traces against committed runner and ratified horizon/currency machinery). Working location: `docs/archive/2026-08-02-milestone-artifacts/prototypes/taxable-interest-composition/it1/`. No repository modifications beyond this design and `examination-it1.md`.
