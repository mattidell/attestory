# Charter: Iteration 2 — Dividend Composition (Clean-Room Rival)
...
- **Builder:** clean-room rival, High tier, independent context. **Sealed:**
  you receive no incumbent material — do not seek `it1/`,
  `examination-it1.md`, or any other builder's work; if any reaches you,
  stop and report.
- **Working location:** `docs/archive/2026-08-02-milestone-artifacts/prototypes/dividend-composition/it2/`; foreman
  holds git custody.
...
reasoning from the ratified contracts alone:
...
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/dividend-composition/it2/design.md` (≤250 lines)
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/dividend-composition/examination-it2.md` (≤100 lines)
...
machinery. Before writing, echo scope, the rung boundary, the clean-room
seal, and stop conditions.
