...
```
PYTHONPATH=. python3 docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it4/tools/harness.py      # I1-I9, 92 checks, exit 0
PYTHONPATH=. python3 docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it4/tools/regression.py   # it3 goldens, 14 scenarios, exit 0
```
