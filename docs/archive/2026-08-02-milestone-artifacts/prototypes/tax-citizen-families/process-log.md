...
- **2026-07-11 (event, builder)** - it1 build complete on branch
  ...
  docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it1/validators/validate_it1.py` passed;
...
- **2026-07-11 (event, rival builder)** - Clean-room it2 build complete on
  ...
  /tmp/tcf-it2-review/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it2/tools/harness.py`
...
- **2026-07-11 (event, builder/foreman)** - Owner reported the owner-launched
  ...
  docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it3/tools/harness.py`; its core checks
...
- **2026-07-11 (event, foreman)** - Foreman independently reran `PYTHONPATH=.
  python3 docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it3/tools/harness.py`; all 203
