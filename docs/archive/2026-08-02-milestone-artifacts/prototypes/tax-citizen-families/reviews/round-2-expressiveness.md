...
docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/examination-it2.md. I did not read
...
p = Path('/tmp/tcf-it2-review/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it2/fixtures/scenarios.json')
...
~~~sh
git archive 989d9fe docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it2 | tar -x -C /tmp/tcf-it2-review
PYTHONPATH=. python3 /tmp/tcf-it2-review/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it2/tools/harness.py
~~~
...
import json
from pathlib import Path
p = Path('/tmp/tcf-it2-review/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it2/tools/harness.py')
...
~~~sh
PYTHONPATH=. python3 /tmp/tcf-it2-review/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it2/tools/harness.py | sed -n '1,13p;59,65p;99,105p'
~~~
...
~~~sh
nl -ba /tmp/tcf-it2-review/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it2/tools/harness.py | sed -n '417,451p;458,488p'
~~~
...
~~~sh
nl -ba /tmp/tcf-it2-review/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it2/tools/harness.py | sed -n '417,451p'
~~~
...
git diff --check -- docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/reviews/round-2-expressiveness.md
...
docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/reviews/round-2-expressiveness.md was also
