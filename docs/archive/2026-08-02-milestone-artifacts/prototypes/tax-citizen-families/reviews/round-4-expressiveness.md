...
```sh
PYTHONPATH=. python3 /tmp/tax-citizen-families-it4-review.5jrr76/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it4/tools/harness.py
PYTHONPATH=. python3 /tmp/tax-citizen-families-it4-review.5jrr76/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it4/tools/regression.py
PYTHONPATH=. python3 /tmp/tax-citizen-families-it4-review.5jrr76/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it4/tools/integration.py
```
