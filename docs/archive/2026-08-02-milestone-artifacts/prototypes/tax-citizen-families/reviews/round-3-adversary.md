...
Baseline command:
    ...
    PYTHONPATH=. python3 /tmp/tcf-it3-review/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it3/tools/harness.py
...
outputs are recorded below. Repository searches used:
    ...
    rg -n "project_closed_sets|closed_sets" packages/derivation docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it3
    find /tmp/tcf-it3-review/docs/archive/2026-08-02-milestone-artifacts/prototypes/tax-citizen-families/it3/instances -type f
