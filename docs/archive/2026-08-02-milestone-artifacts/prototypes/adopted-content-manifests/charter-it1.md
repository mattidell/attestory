...
- **Working location:** `docs/archive/2026-08-02-milestone-artifacts/prototypes/adopted-content-manifests/it1/`; foreman holds git custody.
...
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/adopted-content-manifests/it1/design.md`
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/adopted-content-manifests/examination-it1.md` (≤120 lines) stating ACM-P1 and ACM-P2 separately as settled-at-static-level or unresolved, citing every case.
