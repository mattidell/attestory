...
- **Working location:** `docs/archive/2026-08-02-milestone-artifacts/prototypes/conditional-selectors/it2/` on the milestone branch; foreman holds git custody (no branch, tag, merge, or commit by the builder).
...
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/conditional-selectors/it2/design.md`
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/conditional-selectors/examination-it2.md` (≤120 lines) stating CS-P1 and CS-P2 separately as settled-at-static-level or unresolved, citing every case.
