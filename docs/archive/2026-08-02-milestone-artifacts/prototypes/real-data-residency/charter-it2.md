...
- **Builder:** clean-room rival, High tier, independent context, **sealed from
  the incumbent**.
- **Working location:** `docs/archive/2026-08-02-milestone-artifacts/prototypes/real-data-residency/it2/`; foreman holds git custody.
...
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/real-data-residency/it2/design.md`
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/real-data-residency/examination-it2.md` (≤120 lines) stating
