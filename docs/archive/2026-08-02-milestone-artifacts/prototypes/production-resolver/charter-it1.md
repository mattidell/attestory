...
- **Working location:** `docs/archive/2026-08-02-milestone-artifacts/prototypes/production-resolver/it1/`; foreman holds git custody.
...
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/production-resolver/it1/design.md` (≤ 300 lines)
- `docs/archive/2026-08-02-milestone-artifacts/prototypes/production-resolver/examination-it1.md` (≤ 120 lines) stating
