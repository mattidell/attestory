> **Archive boundary — superseded before ratification.** This Track 0 draft
> was superseded before ratification by accepted ADR-0066. On `main`, ADR
> numbers 0063, 0064, and 0065 now identify different accepted decisions;
> this draft must never be read or cited as any of those ADRs. It is preserved
> only for its C1 evaluation-ordering analysis, `accounts_for` traversal-
> totality proof, and the evidence behind the still-open C3 owner question.
