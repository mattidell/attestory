...
**Governance note.** This Constitution, the Ontology, the Engineering Constraints, the Commentary, and the Principles are versioned artifacts per the Ontology's schema entry. Process records pin the governance versions they operated under (Article 14). Conflicts between this Constitution and the Ontology are defects requiring versioned correction; where both are silent, the Principles interpret.
