...
- **➡️ NEXT ACTION: owner-released, held Conditional Multi-Dependency
  Non-Publication charter.** The incumbent charter at
  docs/prototypes/conditional-multi-dependency-nonpublication/charter-it1.md
  is released but expressly not dispatched: no builder is assigned and no work
  has begun. No rival or reviewer charter is released. D2 evaluation/ADR work
  stays blocked. No production work, D1/D3 reopening, or role dispatch is
  authorized.
