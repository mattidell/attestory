...
- **Track 0 status — 4 of 5 topics settled (citations remain):**
  ...
  - 🔧 **Track 0.c — Citation resolution:** it1 conformant and committed; `charter-it2.md` issued (clean-room sealed from it1 + inert ADR-0018). Awaiting High rival launch. Candidate ADR ~0029.

- **➡️ NEXT ACTION: owner launch Track 0.c High clean-room rival** from
  `docs/prototypes/citation-resolution/charter-it2.md`. Do **not** share it1 or
  ADR-0018. Drop `it2/design.md` + `examination-it2.md`. Then foreman
  conformance → custody → committee charter.
