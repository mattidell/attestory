<!-- foreman-context-v1
{
  ...
  "retrospective": "docs/milestone-retrospectives/2026-08-20-grammar-census-engine-language-map.md",
  "status": "Plan approved in direction by the owner 2026-08-19 and repaired the same day under a bounded planning repair. CLOSED 2026-08-20 — all eight exit criteria met. See docs/phases/grammar-census/exit-criteria-assessment.md and docs/phases/grammar-census/final-report.md for the full assessment; docs/phase-state.md carries the current deliverable chain.",
  "current_role": "none — milestone closed",
