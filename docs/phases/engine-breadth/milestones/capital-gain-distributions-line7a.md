<!-- foreman-context-v1
{
  ...
  "deep_reads": {
    ...
    "review": [
      ...
      "docs/adr/0036-schedule-attachment-ontology.md",
      "docs/adr/0038-qdcg-worksheet-and-declared-absence.md",
      "packages/schemas/derivation/checked-conclusion-binding.v1.schema.json",
      "packages/schemas/derivation/dividend-universe.v2.schema.json",
      "packages/schemas/kernel/quantity-vocabulary.v3.schema.json",
      "packages/content/tax/2025/exception1.bundle.json",
      "packages/content/tax/2025/f1099div-box2a.bundle.json",
      "packages/content/tax/2025/dividend-universe.v2.json",
