<!-- foreman-context-v1
{
  ...
  "status": "TRACK 2 F1/F2 REPAIR IN FOCUSED RECHECK. Luna committed one bounded repair: line 16 now preserves a provably false guard before numeric dependency fallback, and the Track-2 v7 adoption uses a separate v2 registry/release chain while the established v1/v6 route is restored. NEXT ACTION: owner launches the original author-independent Reviewer from `docs/reviews/charter-2026-07-29-capital-gain-distributions-line7a-track2-repair-recheck.md`.",
  "scope": [
