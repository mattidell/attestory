<!-- foreman-context-v1
{
  ...
  "status": "TRACK 0 ACTIVE. Proposed ADR-0050, its advisory index row, and evidence analysis returned at `6ec26fd`. ADR-0050 remains inert and production remains blocked. NEXT ACTION: launch the High/high author-independent Reviewer against docs/prototypes/capital-gain-distributions-line7a/charter-review-adr0050.md.",
  "scope": [
