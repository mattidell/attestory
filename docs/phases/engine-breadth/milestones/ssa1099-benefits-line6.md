...
- Source ref: `origin/main` at
  `b0480bc2178ba7d2fd8baa59b1a6823e5aa5c4a0`.
...
- A separate owner-launched IRA line-4b plan exists at
  `milestone/form1099r-ira-distributions-line4b`, at the same base, with
  Track 0 complete/implementation seats prepared. Its line 4b result is a
  direct worksheet dependency and must be merged before final Social Security
  integration when available.
- A Form 1099-G unemployment branch exists locally but is not on this base and
  has no open PR in the fetched repository. If it merges before this milestone
  reaches Track 2, its line-8 result becomes a prescribed worksheet component;
  otherwise line 8 remains an explicit absence component.
- Current base inventory observes package core `v17` and published registry
  `v12`. These are observations, not reservations. No future schema, rule,
...
| line 4b | Absent on the base; IRA line-4b plan is concurrent | Merge the IRA milestone first when available, then rebase and pin its final line-4b successor once. |
...
| line 8 | Absent on the base; Form 1099-G branch is not ratified here | Use an explicit absence component unless a line-8 successor merges before Track 2; then consume the selected line-8 publication once. |
| line 2a | Closed bounded Form 1099-DIV box-12 line-2a route on the base | Include in W4 and keep excluded from line 9; if a tax-exempt successor merges, rebase and consume the final line-2a result once. |
| Schedule 1 adjustments | No Schedule 1 adjustment families on the base | Use precise absence authorities for lines 11–20, 23, 25 and line 24z eligibility; do not add unrelated adjustment support. |
