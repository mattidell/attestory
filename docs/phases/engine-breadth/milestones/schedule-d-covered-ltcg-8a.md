<!-- foreman-context-v1
{
  ...
  "status": "PLANNED. Milestone and prototype plans merged to `main` in PR #136 (`a05d637`). Track 0's incumbent prototype charter is filed on `prototypes/schedule-d-covered-ltcg-8a/it1`; the incumbent Builder has not yet launched.",
  "scope": [
