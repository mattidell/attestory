<!-- foreman-context-v1
{
  ...
  "status": "TRACK 1 BUILD COMPLETE, REVIEW CHARTERED. Track 1 (`9cf7c73`) publishes the statement anchor, independent eligible-transaction family/closure, and the seven completeness declarations. An author-independent review is chartered on `track/schedule-d-covered-ltcg-8a-track1`.",
  "scope": [
