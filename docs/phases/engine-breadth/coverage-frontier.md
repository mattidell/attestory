...
| 2025 SSA-1099 benefits → Social Security Benefits Worksheet → Form 1040 lines 6a/6b/9 | Returns with one or more ordinary 2025 Form SSA-1099 statements for the taxpayer or joint-return spouse, reconciled nonnegative box-5 benefits, standard worksheet eligibility, and closed component-level authority for every prescribed worksheet input | No SSA-1099 source family, line-6a/6b citizens, worksheet, component-level line-1z/4b/5b/8/Schedule-1 completeness, or Social Security line-9 successor on the ratified base; IRA line 4b and any later line-8/line-7a successors must integrate first | New bounded SSA-1099 family and lifecycle, auditable non-filed worksheet, exact line-6 indicators, component-level closure, and additive line-9 succession; prefer reuse of accepted identity, closure, explanation, package, and presentation contracts | Paper-first exception inventory, production-shaped synthetic source/lifecycle/worksheet, exact-once component pins, package/explanation/presentation evidence, and independent review | **selected** |
