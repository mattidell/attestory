...
| Inbound capital-loss carryovers | Returns within the supported covered, basis-reported, no-adjustment capital-transaction class carrying a short-term or long-term capital-loss carryover derived from authoritative 2024 return-line facts, included on 2025 Schedule D lines 6 and 14 | No carryover source, authority, or year-boundary contract; deliberately excluded from the current-year-losses slice; no amount carried into 2026 is derived or published by this slice | A bounded prior-return authority for the necessary 2024 Form 1040/Schedule D line values, the Capital Loss Carryover Worksheet as an auditable derived worksheet citizen, and a completeness successor retiring `no-inbound-capital-loss-carryovers` | Paper-first Track 0 contract evidence, production-shaped synthetic coordinator, lifecycle, completeness, package, explanation, and presentation evidence | **selected** |
