...
| Broker-furnished noncovered basis → Form 8949 boxes B/E → Schedule D lines 2/9 | Returns within the supported Form 1099-B class carrying one or more transactions whose basis the broker shows to the recipient but does not report to the IRS, accepted as correct, with no adjustment code and column (g) zero — short-term to Form 8949 box B and Schedule D line 2, long-term to box E and line 9 | Selected for the bounded broker-furnished-basis class; absent basis, taxpayer-determined or reconstructed basis, code-B basis corrections, any other adjustment code, and Form 1099-DA remain deliberately excluded | Noncovered transaction authority with basis entering as an asserted broker finding and no document-child identity, generalized transaction-identity collision kill-test across the direct/code-W/noncovered families, a third completeness path admitting exactly this class, and Form 8949 box-B/box-E parts with Schedule D line-2/line-9 composition | Paper-first Track 0 decision record plus production-shaped synthetic source, lifecycle, completeness, package, explanation, citation, and presentation evidence through `live_coordinate_run` | **selected — planned** |
| Other Form 8949 adjustment codes and basis corrections | Returns with Form 8949 adjustment codes besides W, broker-basis corrections (code B), multi-code rows, or taxpayer-determined basis | No authority or arithmetic for any code besides W; no taxpayer-side basis determination | Each remaining adjustment code needs its own authority and arithmetic; taxpayer-determined basis needs a distinct basis-source contract | Its own paper-first contract evidence once selected | candidate |
...
| Fully taxable IRA-family distributions from Form 1099-R → Form 1040 line 4b | Returns with one or more 2025 Form 1099-R ordinary, fully taxable IRA-family distributions, with line 4a blank/absent and the statement facts sufficient to identify the bounded class | Retired for the bounded ordinary fully-taxable IRA-family class; basis, rollover eligibility, and special distribution treatment remain honestly outside it | Narrow independent Form 1099-R authority and completeness boundary; successor line 4b and line 9/AGI/taxable-income composition; package, explanation, exact citation pins, and production-shaped presentation | Paper-first Track 0 decision record plus Track 1/Track 2 synthetic source, lifecycle, closure, downstream, package, explanation, and presentation evidence; merged to `main` in PR #162 (`9cecf30`) | **synthetic complete** |
| 2025 SSA-1099 benefits → Social Security Benefits Worksheet → Form 1040 lines 6a/6b/9 | Returns with one or more ordinary 2025 Form SSA-1099 statements for the taxpayer or joint-return spouse, reconciled nonnegative box-5 benefits, standard worksheet eligibility, and closed component-level authority for every prescribed worksheet input | Retired for the bounded ordinary SSA-1099 standard-worksheet class; lump-sum elections, Form 8815/8839/Puerto Rico exclusions, and nonstandard worksheet variants remain honestly outside it | New bounded SSA-1099 family and lifecycle, auditable non-filed worksheet, exact line-6 indicators, component-level closure, and additive line-9 succession; reuse accepted identity, closure, explanation, package, and presentation contracts | Paper-first exception inventory, production-shaped synthetic source/lifecycle/worksheet, exact-once component pins, package/explanation/presentation evidence, and independent review; merged to `main` in PR #163 (`48d46f9`) | **synthetic complete** |
