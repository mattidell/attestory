...
| Noncovered / basis-not-reported Form 8949 transactions | Returns with noncovered securities, broker-basis corrections, or other Form 8949 adjustment codes besides W | The prerequisite is **delivered**: PR #174 merged the accepted ADR-0066 declarative-validation substrate. No substrate blocker remains; this slice now requires a fresh Track 0 contract written against that substrate. | The old proposed ADR-0063/0064/0065 drafts were superseded before ratification. ADR-0066 Decision 5 independently and authoritatively supplies reachability-derived validation dependencies plus checked `accounts_for`; it solves the old “no attachment citizen declares which line symbols it accounts for” problem without the parallel `accounts_for` mechanism old ADR-0065 Decision 8 invented against a package four versions stale. | Re-cut Track 0 from ADR-0066, reusing only the archived C1 evaluation-ordering analysis and traversal-totality proof; settle the still-open C3 closure-gate question before any implementation | **unblocked — requires re-cut contract** |
...
| Fully taxable IRA-family distributions from Form 1099-R → Form 1040 line 4b | Returns with one or more 2025 Form 1099-R ordinary, fully taxable IRA-family distributions, with line 4a blank/absent and the statement facts sufficient to identify the bounded class | Retired for the bounded ordinary fully-taxable IRA class; basis, rollover eligibility, and special distribution treatment remain excluded | Narrow independent Form 1099-R authority and completeness boundary; successor line 4b and line 9/AGI/taxable-income composition; package, explanation, exact citation pins, and production-shaped presentation | Paper-first Track 0 decision record plus production-shaped synthetic source, lifecycle, closure, downstream, package, explanation, and presentation evidence (PR #162) | **synthetic complete** |
| 2025 SSA-1099 benefits → Social Security Benefits Worksheet → Form 1040 lines 6a/6b/9 | Returns with one or more ordinary 2025 Form SSA-1099 statements for the taxpayer or joint-return spouse, reconciled nonnegative box-5 benefits, standard worksheet eligibility, and closed component-level authority for every prescribed worksheet input | Retired for the bounded ordinary statement and worksheet-eligible class; excluded statement/worksheet cases remain outside it | New bounded SSA-1099 family and lifecycle, auditable non-filed worksheet, exact line-6 indicators, component-level closure, and additive line-9 succession; reuse accepted identity, closure, explanation, package, and presentation contracts | Paper-first exception inventory, production-shaped synthetic source/lifecycle/worksheet, exact-once component pins, package/explanation/presentation evidence, and independent review (PR #163) | **synthetic complete** |
