...
| Schedule B interest adjustments | Returns with nominee distributions, accrued interest paid to a bond seller, or taxable amortizable-bond-premium adjustments | No explicit adjustment authority or Schedule B Part I subtraction mechanism | New adjustment authority, closure, explanation, and attachment-row semantics | Paper-first contract evidence, then positive/negative adjustment goldens | **selected** |
...
The fourth milestone, **Schedule B Interest Adjustments**, is selected for a
bounded 2025 class covering nominee distributions, accrued interest paid to a
bond seller, and taxable amortizable-bond-premium adjustments. It is separate
from Schedule D and accepts explicit adjustment authority; it does not calculate
nominee ownership, accrued interest, bond-premium amortization, or any capital
transaction. Plan: `milestones/schedule-b-interest-adjustments.md`.
