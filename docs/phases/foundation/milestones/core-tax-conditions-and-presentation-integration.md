...
**Update (2026-07-15):** ADR-0027 accepted (manifests floor); residual micro-round closed with **ADR-0028 accepted** (fact surface + composition obligation). Track 0.b complete. Track 0.c citation plan proposed.
...
- ✅ **0.b Adopted-content manifests → ADR-0027 + ADR-0028 accepted** (2026-07-15; supersedes inert ADR-0022). Floor + fact-surface membership + composition-obligation trigger (A7-broadened force-declare; rationale on record). Track 4 full membership closure unblocked.
