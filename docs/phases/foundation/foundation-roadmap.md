...
Active work: **Derivation Cascade Reconciliation patch** (charter: `docs/reviews/2026-07-11-derivation-cascade-reconciliation.md`; decision: ADR-0010) — closes the correction cascade through the derivation machinery before First Tax Slice authors content. Next milestone: **First Tax Slice** (planning input: `milestones/first-tax-slice-inputs.md`; not yet planned).
...
- Derivation Cascade Reconciliation patch — **scheduled, not started** (charter: `docs/reviews/2026-07-11-derivation-cascade-reconciliation.md`; ADR-0010 ratified 2026-07-11). Closes the correction cascade: derived-publication acts admitted to the act log via a combined registry, derived findings folded into displacement via a compose-over derivation-currency layer, proven by a supersession golden. Precedes First Tax Slice. Precedent: `patch-kernel-reconciliation`.
