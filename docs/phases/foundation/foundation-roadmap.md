...
Active milestone: **First Tax Slice** (plan: `milestones/first-tax-slice.md`; planning input preserved at `milestones/first-tax-slice-inputs.md`). Status: Track 0 prototype process open at `docs/prototypes/tax-citizen-families/SEAT.md`; no implementation branch yet. The Derivation Cascade Reconciliation patch is complete (merge `18ce073`), so the machinery is whole — the slice can carry a supersession acceptance golden.
...
- First Tax Slice — **Track 0 prototype open** (plan: `milestones/first-tax-slice.md`; planning input: `milestones/first-tax-slice-inputs.md`; seat file: `docs/prototypes/tax-citizen-families/SEAT.md`). Pure content on the finished machinery; authored after the cascade patch so it can carry a supersession acceptance golden. Implementation waits on Track 0's form-field/fact-type/source-closure/rendered-absence contract decision.
