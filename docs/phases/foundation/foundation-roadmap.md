...
Active milestone: **First Tax Slice** (plan: `milestones/first-tax-slice.md`; planning input preserved at `milestones/first-tax-slice-inputs.md`). Status: Track 0 complete; ADR-0011/0012 ratified; narrowed implementation plan committed; execution branch `milestone/first-tax-slice` created 2026-07-11 from a green baseline. The milestone now ships W-2 box 1 -> Form 1040 line 1a only.
...
- First Tax Slice — **in execution on `milestone/first-tax-slice`** (plan: `milestones/first-tax-slice.md`). Track 0 concluded with ADR-0011/0012 and a narrow evaluation analysis. Scope is W-2 box 1 -> line 1a, form-field content, present zero, correction/displacement, and explicit re-derivation. Broader closure, 1099-INT, coverage, downstream tax conditions, citation authority, and non-publication explanations are deferred to roadmap items 6-7.
