...
- **Don't re-run the full suite by default.** Reference the builder's recorded
  gate result (`pytest: N passed @ <sha>`, AGENTS.md "Test economy"); run `pytest`
  yourself only to confirm a specific failing claim, not as routine.
