...
- Review being repaired: `docs/reviews/2026-07-28-entry-boundary-track2-review.md`
...
`docs/phases/legible-entry/milestones/entry-boundary-retention-findings.md` as a
