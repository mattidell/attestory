...
confinement. The review (`docs/reviews/2026-07-28-entry-boundary-track1-review.md`)
...
`docs/phases/legible-entry/milestones/entry-boundary-retention-findings.md` so
