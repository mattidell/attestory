...
- Track: 2 of `docs/phases/real-return/milestones/presentation-real-session-attestation.md`
- Charter: `docs/reviews/charter-2026-07-27-presentation-real-session-attestation-track2.md`
