...
`docs/reviews/charter-2026-07-19-dsbs-t0a-cmdn-review.md`. Reviewer read only
the charter, the Track 0a plan section (`docs/phases/real-return/milestones/
dividends-schedule-b-slice.md`), ADR-0037 with its cited CMDN prototype
evidence (`docs/prototypes/conditional-multi-dependency-nonpublication/`),
...
- **Check 5 (scope fence):** no QDCG worksheet, declared-absence fact type,
  ...
  `docs/phases/real-return/milestones/dividends-schedule-b-slice.md`,
