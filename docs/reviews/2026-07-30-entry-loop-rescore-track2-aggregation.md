...
- Role: Builder, Track 3 (`docs/reviews/charter-2026-07-30-entry-loop-rescore-track3.md`)
- Inputs re-derived directly from the two filed score sheets, row by row, not
  ...
  - `docs/reviews/2026-07-30-entry-loop-rescore-track2-evaluator-e.md`
    (Evaluator E, Builder brief; commit `b9c1afe`)
  - `docs/reviews/2026-07-30-entry-loop-rescore-track2-evaluator-f.md`
