...
- Build charter: `docs/reviews/charter-2026-07-29-entry-loop-synthetic-track3.md`
...
`docs/phases/legible-entry/milestones/entry-loop-synthetic.md` (129 added lines)
