...
`docs/reviews/2026-07-15-core-tax-conditions-r4-independent-rereview.md`; the
foreman retains commit custody and does not review the finding's merits.

## Read order

1. `docs/reviews/SEAT.md`
2. This charter and its parent remediation charter
3. `docs/reviews/2026-07-15-core-tax-conditions-premerge-review.md`
...
6. `docs/reviews/2026-07-15-core-tax-conditions-r3-verification.md`
