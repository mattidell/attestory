...
ADR-0034 against
`docs/reviews/charter-2026-07-20-dsbs-t4-dividend-live-integration-review.md`.
...
- `git show --stat fcbf70b`: exactly three files —
  `.gitignore` (+5), `docs/reviews/note-2026-07-20-dsbs-t4-closing.md`
...
`docs/reviews/note-2026-07-20-dsbs-t4-closing.md` names the F1 discrepancy
