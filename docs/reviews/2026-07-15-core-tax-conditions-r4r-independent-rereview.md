...
Charter: `docs/reviews/charter-2026-07-15-core-tax-conditions-r4r-independent-rereview.md`
...
- **Evidence:** The R3R verification record (`docs/reviews/2026-07-15-core-tax-conditions-r3r-verification.md`) reports green results for `.venv/bin/python3 -m unittest`, `.venv/bin/python3 -m mypy`, and `.venv/bin/python3 tools/governance_lint.py`.
