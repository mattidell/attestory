...
Active milestone: **Source Completeness And Interest Slice** — ADR-0014 and ADR-0015 ratified 2026-07-12. Accepted contracts: reusable adopted source-closure mapping with affirmative-only single dispatch, and logical 1099-INT statement-instance identity. The deferred SC-P3 source-family claim/coverage boundary blocks honest closure-backed interest zero and coverage; a separate paper-first plan is drafted at `docs/prototypes/source-family-semantics/plan.md` and awaits owner approval before implementation replanning. First Tax Slice completed 2026-07-11 (merge `c548766`; retrospective `docs/milestone-retrospectives/2026-07-11-first-tax-slice.md`).
