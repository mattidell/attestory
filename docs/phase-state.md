...
**Milestone plan revised 2026-07-14** (see the milestone doc's revision note): Track 0 is **2 of 5 topics complete**. The remaining three — taxable-interest composition (ADR-0021), adopted-content manifests (ADR-0022), citation resolution (ADR-0018) — were found to be **non-conforming single-author paper spikes** (0018 has no prototype artifact at all), inert per the ADR-0013 amendment. Owner directed (2026-07-14) that all three be remediated with conforming incumbent + clean-room rival + committee rounds before their implementation tracks open. Implementation tracks 1–7 rebuild on the ratified ADRs and inherit their production conditions. **Next: draft the Track 0.a interest-composition prototype plan.**
