...
Active milestone: **Source Completeness And Interest Slice** — initial plan at `docs/phases/foundation/milestones/source-completeness-and-interest-slice.md`. Status: Track 0 launched 2026-07-12 under owner-approved `docs/prototypes/source-completeness/plan.md`; both paper rivals and two committee rounds are complete. Owner ratified partial continuation for SC-P1/SC-P2 and deferred SC-P3. Repair passes 1–2 proved affirmative-only enforcement through a copied calculation path, but round 2 found that callers can fabricate the trusted authority carrier. Shape B is rejected for rule-evolution outage; bounded repair pass 3 is prepared on shape A only to close the construction/invariant boundary. Tracks 1+ remain provisional, contingent on Track 0 ADR ratification. First Tax Slice completed 2026-07-11 (merge `c548766`; retrospective `docs/milestone-retrospectives/2026-07-11-first-tax-slice.md`).
