...
Update (2026-07-14, principal foreman): the two rule-language engine decisions are now ratified — **ADR-0024** (conditional structures; owner ratification 2026-07-13) and **ADR-0025** (expression-language extensions: declared optional defaults + categorical comparison; owner ratification 2026-07-14, closing the `expression-language-extensions` topic on the clean-room rival's mechanisms). ADR-0019 rejected/retained. This unblocks the milestone's Track 1 (conditional-structure schemas, rebuilt under 0024) and Track 3 (conditional structures, rebuilt under 0024 + 0025); ELX production conditions PC1–PC3 land in that implementation. **NPE remains open:** ADR-0020 redrafted to the converged durable-run-disposition-ledger shape, still proposed pending round-3 review. Next: NPE round 3, then owner milestone-plan revision + Tracks 1–3 re-run.
