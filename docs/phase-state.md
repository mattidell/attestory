...
## Product briefing (as of 2026-07-24, process-economy Track 0 delta review)
...
Track 0 participant-cost repair landed in `4f8a07c`; the independent delta
Reviewer is the current role and its prompt is prepared.
Plan:
