<!-- foreman-context-v1
{
  ...
  "current_role": "Foreman — Entry Boundary, Track 2 repair chartered (widen probe past the confined directory, then fix ADR-0048)",
  "current_prompt": "docs/reviews/charter-2026-07-28-entry-boundary-track2-repair.md"
}
-->
# Phase State
