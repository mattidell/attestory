...
Correction (2026-07-13, principal foreman): ADRs 0018–0022 are **proposed, not ratified** — the previous "ratified" claim here was wrong. Track 0 did not conform to the approved prototype plans (clean-room rival seats skipped in `conditional-selectors` and `non-publication-explanations`); remediation ran under owner pacing (see each topic's process log and SEAT). NPE remediation is complete through round-2 triage; ADR-0020 is redrafted to the converged shape (durable run disposition ledger) and remains proposed pending post-round-1R review. CS round-1R re-review is in progress; ADR-0019 remains proposed and on hold. Owner-directed reset (2026-07-13): track implementation built on proposed ADRs was removed from the milestone branch — pre-reset history preserved at `archive/core-tax-conditions-pre-reset`, Track 3 WIP at `wip/track3-core-conditions` (c8be492). Tracks 1–3 re-run after ratification; per the ADR-0013 amendment (2026-07-13), non-accepted ADRs are inert and every prototype round requires independently contexted rival evidence.
