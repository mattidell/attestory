...
**Milestone plan revised 2026-07-14** (see the milestone doc's revision note): Track 0 is **3 of 5 topics complete**. Taxable-interest composition closed as **ADR-0026 accepted** (Track 0.a; mechanism + honest-partial OID-inclusive line-2b boundary; supersedes inert ADR-0021). The two remaining topics — adopted-content manifests (inert ADR-0022) and citation resolution (inert ADR-0018, no prototype artifact at all) — are non-conforming single-author spikes needing full remediation with conforming incumbent + clean-room rival + committee rounds before their implementation tracks open. Owner sequenced manifests (Track 0.b) next, then citations (Track 0.c). Implementation tracks 1–7 rebuild on the ratified ADRs and inherit their production conditions. **Next: begin Core Tax Conditions implementation tracks** (Track 0 complete — ADRs 0020, 0024–0029 accepted). Owner paces track order per milestone plan. Phase: Foundation; branch `milestone/core-tax-conditions`.
