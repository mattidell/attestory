...
- Status: **accepted** (owner-directed reconstruction of the previously
  accepted 2026-08-02 decision; foreman-run paper spike, Gate 1 scores below
...
(`docs/archive/2026-08-02-schedule-d-covered-ltcg-evidence/prototypes/schedule-d-covered-ltcg-8a/ca05-ca06-paper-spike.md`) —
...
- Paper spike: `docs/archive/2026-08-02-schedule-d-covered-ltcg-evidence/prototypes/schedule-d-covered-ltcg-8a/ca05-ca06-paper-spike.md`
