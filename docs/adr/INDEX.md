...
| 0041 | proposed | facts, closure | Inert (awaiting ratification): closes `supersession.policy` to `free`/`locked`/`closed-on-attestation`; state-gated only, no actor/identity concept. |
