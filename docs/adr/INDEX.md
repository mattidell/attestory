...
| 0042 | accepted | process, context | A deterministic, explicit-ref foreman capsule routes reading from validated source blobs; advisory only, fail-closed on inconsistent volatile state, with full action-specific reads still controlling. |
