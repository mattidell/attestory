...
- Status: **accepted** (owner-directed reconstruction of the previously
  accepted 2026-08-02 decision; publication is carried by this milestone PR)
...
`docs/archive/2026-08-02-schedule-d-covered-ltcg-evidence/prototypes/schedule-d-covered-ltcg-8a/`: sealed incumbent `it1`
...
`docs/archive/2026-08-02-schedule-d-covered-ltcg-evidence/prototypes/schedule-d-covered-ltcg-8a/evaluation-analysis.md`.

The owner directed this previously accepted decision unit to be reconstructed
after resetting the earlier Schedule D development history. This ADR carries
contract authority on the milestone branch; production Tracks 1–3 implement
the contracts below.
...
## Production conditions (owed by the production tracks; never allowlisted)
...
- Prototype evidence:
  `docs/archive/2026-08-02-schedule-d-covered-ltcg-evidence/prototypes/schedule-d-covered-ltcg-8a/` (`plan.md`,
...
- Consumed by: Engine Breadth production Tracks 1–3 for covered long-term
  gains / Schedule D line 8a on this milestone branch
