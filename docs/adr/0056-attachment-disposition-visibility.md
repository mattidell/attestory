...
landed a charter-stop finding: `_resolve_attachment` in
...
## Production conditions (discharged by Track 3's implementation in this milestone)
...
- Implemented by: Track 3's presentation-route commit in this milestone.
