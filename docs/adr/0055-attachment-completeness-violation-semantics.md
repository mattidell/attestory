...
landed with a flagged, not-allowlisted production condition:
...
## Production conditions (discharged by Track 2's implementation in this milestone)
...
- Implemented by: Track 2's production-route commit in this milestone.
