...
- Evidence: `docs/archive/2026-08-02-milestone-artifacts/prototypes/taxable-interest-composition/evaluation-analysis.md`; `reviews/round-1-governance.md`, `reviews/round-1-adversary.md`; exhibits `it1/design.md` (`4ea0b6c`), `it2/design.md` (`f3ccb43`).
