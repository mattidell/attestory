...
- Status: **accepted** (owner-directed reconstruction of the previously
  accepted 2026-08-02 decision; foreman-run paper spike, Gate 1 scores in the
...
The pre-curation Track 2 Builder reported a charter stop, preserved on
`snapshot/2026-08-02-schedule-d-covered-ltcg-pre-curation` at `4af36ca`:
...
`docs/archive/2026-08-02-schedule-d-covered-ltcg-evidence/prototypes/schedule-d-covered-ltcg-8a/track2-multi-scalar-member-paper-spike.md`.
...
- Track 2 can resume under a revised charter on this milestone branch. This
  ADR settles how Schedule D content sources its column sums; the remaining
...
- Paper spike: `docs/archive/2026-08-02-schedule-d-covered-ltcg-evidence/prototypes/schedule-d-covered-ltcg-8a/track2-multi-scalar-member-paper-spike.md`
...
- Consumed by: Covered Long-Term Gains, Schedule D Line 8a production Track 2
  under its revised milestone-branch charter
